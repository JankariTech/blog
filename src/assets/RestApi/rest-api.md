...
## What is a REST API?
REST, serves as an architectural approach for creating networked apps. It operates via a stateless client-server communication system. In this model, clients and servers exchange representations of resources identified by URIs. Access is facilitated through standard HTTP methods such as GET, POST, PUT, DELETE, and others.
...
- `methods=["GET]` specifies that this route should respond the HTTP GET requests. This means that when a client sends a GET request to the `/tasks` URL, Flask will call the associated function.
...
- `methods=["GET"]` specifies that this route should respond to HTTP GET requests. This means that whan a client sends a GET request to the `tasks/<int:task_id>` URL, Flask will call the associated function.
...
- `methods=["POST"]` specifies that this route should respond to HTTP POST requests. This means when a client sends a POST request to the `/tasks` URL, Flask will call the associated function.
...
- `@app.route` binds a URL pattern `/tasks/<int:task_id>` to the function that follows it.
- `<int:task_id>` is a variable part of the URL that will be captured and passed to the function as an argument.
- `methods=["PUT"]` specifies that this route should respond to HTTP PUT requests. This means that when a client sends a PUT request to the `/tasks/<int:task_id>` URL, Flask will call the associated function.
...
- `@app.route` binds a URL pattern `/tasks/<int:task_id>` to the function that follows it.
- `<int:task_id>` is a variable part of the URL that will be captured and passed to the function as an argument.
- `methods=["DELETE"]` specifies that this route should respond to HTTP DELETE requests. This means that when a client sends a DELETE request to the `/tasks/<int:task_id>` URL, Flask will call the associated function.
