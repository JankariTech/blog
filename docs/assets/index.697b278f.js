...
Please report this to https://github.com/markedjs/marked.`,t.silent)return"<p>An error occurred:</p><pre>"+ye(n.message+"",!0)+"</pre>";throw n}};L.Parser=rt;L.parser=rt.parse;L.Renderer=Js;L.TextRenderer=ki;L.Lexer=ot;L.lexer=ot.lex;L.Tokenizer=Ks;L.Slugger=Ti;L.parse=L;L.options;L.setOptions;L.use;L.walkTokens;L.parseInline;rt.parse;ot.lex;L.setOptions({sanitize:!0,headerIds:!0});const cu=()=>({fileModules:{"/src/assets/BDDInGo.md":`---
